...
// ---------------------------------------------------------------------------
// FAQ interne (incluse dans le prompt système)
// ---------------------------------------------------------------------------
const FAQ = `
FAQ ZT Technologies :
...
// ---------------------------------------------------------------------------
// Prompt système (définit le ton, les règles et les connaissances de l'IA)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Stockage des conversations (mémoire volatile)
// ---------------------------------------------------------------------------
...
function addToHistory(sessionId, role, content) {
  ...
  // Garder seulement les N derniers échanges (N paires = 2*N messages)
...
// ---------------------------------------------------------------------------
// Réponses instantanées (expressions régulières) – évitent un appel à l'IA
// ---------------------------------------------------------------------------
...
exports.chat = async (req, res) => {
  ...
  try {
    ...
    console.log(`🤖 Appel DeepSeek... (session: ${currentSessionId}, ${history.length} échanges précédents)`);

    // 4. Appel à l'API DeepSeek
    ...
    console.log(`✅ Réponse DeepSeek (${duration}ms) [session: ${currentSessionId}]`);
