      ...
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          ...
          <div className="flex gap-4 mt-4">
            <a
              href="https://www.facebook.com/profile.php?id=100071334675128"
              target="_blank"
            ...
            <a
              href="https://www.tiktok.com/@zt.voyage8?_r=1&_t=ZS-99bOCo4thTO"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="TikTok"
            ...
            <a
              href="https://wa.me/2290152431717"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="WhatsApp"
        ...
        <div>
          ...
          <nav aria-label="Navigation secondaire" className="space-y-2">
            ...
            <Link to="/location-voiture" className="block text-gray-400 hover:text-primary dark:hover:text-white transition">Location de voiture</Link>
