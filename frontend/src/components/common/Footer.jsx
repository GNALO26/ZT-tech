      ...
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <nav aria-label="Navigation secondaire" className="space-y-2">
            ...
            <Link to="/services" className="block text-gray-400 hover:text-primary dark:hover:text-white transition">Services</Link>
            <Link to="/contact" className="block text-gray-400 hover:text-primary dark:hover:text-white transition">Contact</Link>
            <Link to="/about" className="block text-gray-400 hover:text-primary dark:hover:text-white transition">À propos</Link>
          </nav>
        </div>
        <div>
